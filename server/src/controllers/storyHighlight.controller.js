...
export const createHighlight = async (req, res) => {
  try {
    ...
    const populated = await StoryHighlight.findById(
      highlight._id
    ).populate("stories");
...
export const addStoryToHighlight = async (req, res) => {
  try {
    ...
    // Check that the story belongs to the logged-in user.
    ...
    // Check that the highlight belongs to the logged-in user.
    ...
    // Add story without creating duplicates.
