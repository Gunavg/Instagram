...
const en: Dictionary = {
  ...
  subscriptionActivated:"Subscription activated", paymentVerified:"Your payment has been verified successfully.",
...
const translations: Record<LanguageCode, Dictionary> = {
  ...
  hi:Object.assign({...en, freePlan:"फ्री प्लान", bronzePlan:"ब्रॉन्ज़ प्लान", silverPlan:"सिल्वर प्लान", goldPlan:"गोल्ड प्लान", onePost:"1 पोस्ट", threePosts:"3 पोस्ट", fivePosts:"5 पोस्ट", unlimitedPosts:"अनलिमिटेड पोस्ट", planWord:"प्लान", subscriptionActivated:"सब्सक्रिप्शन सक्रिय हो गया", paymentVerified:"आपके भुगतान का सफलतापूर्वक सत्यापन हो गया है।", paymentVerificationFailed:"भुगतान सत्यापन विफल रहा।", unableStartPayment:"भुगतान शुरू नहीं किया जा सका।", paymentHours:"भुगतान समय: सुबह 5:00 से 11:00 IST।", planRemainsActive:"आपका वर्तमान प्लान बिलिंग अवधि समाप्त होने तक सक्रिय रहेगा।", unableCancelSubscription:"सब्सक्रिप्शन रद्द नहीं किया जा सका।", month:"महीना", current:"वर्तमान", "status.active":"सक्रिय", "status.past_due":"बकाया", "status.canceled":"रद्द", "status.incomplete":"अपूर्ण", "status.unpaid":"भुगतान नहीं हुआ"}),
