          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-1.5">
            ...
            <div>
              <input
                ...
                className={`w-full bg-ig-bg border rounded-[3px] text-[12px] px-2 py-2.25 focus:outline-none placeholder:text-ig-muted transition-colors text-ig-text ${
                  errors.email
                    ? "border-[#ed4956]"
            ...
            <div>
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  minLength={6}
                  className={`w-full bg-ig-bg border rounded-[3px] text-[12px] px-2 py-2.25 pr-16 focus:outline-none placeholder:text-ig-muted transition-colors text-ig-text ${
                    errors.password
                      ? "border-[#ed4956]"
                      : "border-ig-border focus:border-ig-muted"
                  }`}
