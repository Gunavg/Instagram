  ...
  return (
    <div className="min-h-screen bg-ig-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full flex gap-8 items-center justify-center max-w-225">
          {/* Left – phone mockup (desktop only) */}
          <div className="hidden lg:flex flex-col items-center justify-center w-95 shrink-0">
            <div className="relative w-62.5 h-125">
              {/* Phone frame */}
              <div className="absolute inset-0 rounded-[36px] border-4 border-ig-text bg-ig-surface shadow-2xl overflow-hidden">
                ...
                <div className="h-8 bg-ig-surface flex items-center justify-between px-5 pt-2">
                  ...
                  <div className="flex items-center gap-1">
                    <div className="w-3 h-2 border border-ig-text rounded-xs relative">
                      <div className="absolute left-px top-px bottom-px right-0.75 bg-ig-text rounded-[1px]" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="px-3 py-2">
                    ...
                    <div className="flex gap-2 overflow-hidden mb-3">
                      {[
                        ...
                        >
                          <div className="w-10 h-10 rounded-full story-gradient p-0.5">
            ...
            <div className="bg-ig-surface border border-ig-border rounded-sm px-10 pt-10 pb-6">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-1.5">
                <input
                  ...
                  className="w-full bg-ig-bg border border-ig-border rounded-[3px] text-[12px] px-2 py-2.25 focus:outline-none focus:border-ig-muted placeholder:text-ig-muted text-ig-text"
                />
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-ig-bg border border-ig-border rounded-[3px] text-[12px] px-2 py-2.25 pr-16 focus:outline-none focus:border-ig-muted placeholder:text-ig-muted text-ig-text"
                  />
                  {password && (
                    <button
                      type="button"
